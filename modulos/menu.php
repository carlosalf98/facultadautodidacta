  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link active colorLetra " aria-current="page" href="inicio.php"><i class="fa-solid fa-house-laptop"></i> Inicio</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <i class="fa-solid fa-list-check"></i> Listas de invitados</a>
        </li>
