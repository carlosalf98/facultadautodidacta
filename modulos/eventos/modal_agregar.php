...
<form id="frmAgregarEvento" onsubmit="return agregarEvento();">
  <!-- Modal -->
  <div class="modal fade" id="modal_agregar_evento" tabindex="-1" aria-labelledby="modal_agregar_evento" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal_agregar_eventoLabel">Agregar eventos</h5>
